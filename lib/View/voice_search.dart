...
class _VoiceSearchPageState extends State<VoiceSearchPage> {
        ...
        child: AnimatedScale(
          ...
          child: FloatingActionButton(
            ...
            foregroundColor: _isListening || _recognizedText.isNotEmpty
                ? Colors.white
                : Colors.red,
            backgroundColor: !_isListening && _recognizedText.isNotEmpty && _isSearching?
                Colors.black:!_isListening && _recognizedText.isNotEmpty && !_isSearching?
                Colors.blue
  ...
  Future<void> _handleMicPermission() async {
    ...
    if (status == PermissionStatus.denied) status = await Permission.microphone.request();
    switch (status) {
